            ...
            grouploop: function (i) {
                var n,
                    ...
                    a =
                        f(window).width() < 768
                            ...
                            : f(o).width(),
                    s = f(o)
                        .find(r.childWrapper + " " + r.childNode)
                        .first(),
                ...
                return (
                    ...
                    window.addEventListener("resize", function () {
                        (d = f(window).width()) < 768
                            ? (console.log(
                                  "Small breakpoint. Wrapper width is currently doubled."
                              ),
                              (d *= 2),
                              (a = 2 * f(o).width()))
                            : ((d = f(window).width()), (a = f(o).width())),
                            r.stickFirstItem && h();
                    }),
                    r.forward
                        ? ((n = -d),
                          f(o).each(function (i, n) {
                              f(n)
                                  .find(r.childWrapper)
                                  .each(function (i, n) {
                                      f(
                                          f(n).find(
                                              f(r.childNode).get().reverse()
                                          )
                                      ).each(function () {
                        ...
                        : ((n =
                              "none" !==
                              f(o).find(r.childWrapper).css("transform")
                                  ? f(o)
                                        .find(r.childWrapper)
                                        .css("transform")
                                        .split(/[()]/)[1]
                ...
                function (a, b, c) {
                    ...
                    return (
                        ...
                        (q.addPause = function (a, b, d, e) {
                            ...
                            return (
                                (f.vars.onComplete = f.vars.onReverseComplete =
                                    b),
                                (f.data = "isPause"),
                                (this._hasPause = !0),
                                this.add(f, a)
                        ...
                        (q.totalTime = function (b, c, d) {
                            ...
                            var e = a.prototype.totalTime.apply(
                                this,
                                arguments
                            );
                ...
                function (a, b, c) {
                    ...
                    return (
                        ...
                        (k.tweenFromTo = function (a, b, c) {
                            ...
                            return d.duration(
                                Math.abs(d.vars.time - a) / this._timeScale ||
                                    0.001
                            );
                        }),
                ...
                function (a, b) {
                    ...
                    var k,
                        ...
                        ga = function (a, b, c) {
                            ...
                            for (c = c || $(a, null); --f > -1; )
                                (d -=
                                    parseFloat(_(a, "padding" + e[f], c, !0)) ||
                                    0),
                                    (d -=
                                        parseFloat(
                                            _(
                    ...
                    var xa = function (a, b) {
                        ...
                        ya = (S._registerComplexSpecialProp = function (
                            a,
                            b,
                            c
                        ) {
                    ...
                    var Aa,
                        ...
                        Ka = (function () {
                            var a,
                                ...
                                d =
                                    p ||
                                    (/Android/i.test(T) && !_gsScope.chrome);
                            return (
                                O.createElementNS &&
                                    !d &&
                                    ((a = Ia("svg", Ja)),
                        ...
                        Ra = (S.getTransform = function (a, c, d, e) {
                            ...
                            var f,
                                ...
                                q = Fa
                                    ...
                                    : 0,
                                r =
                                    parseFloat(g.defaultTransformPerspective) ||
                                    0;
                            if (
                                ((m.svg = !(!a.getCTM || !Oa(a))),
                                m.svg &&
                            ...
                            if (m) {
                                ...
                                if (
                                    ...
                                    (0 === a || 1 === a) &&
                                        ...
                                        1 === k &&
                                        ((s &&
                                            -1 === t.indexOf("Dx=0, Dy=0")) ||
                                            (x.test(b) &&
                                                100 !==
                                                    parseFloat(RegExp.$1)) ||
                                            (-1 ===
                                                b.indexOf(b.indexOf("Alpha")) &&
                    ...
                    var Va = function (a, b) {
                        ...
                        Wa = function (a) {
                            if (
                                ((this.t._gsClassPT = this), 1 === a || 0 === a)
                            ) {
                                this.t.setAttribute(
                                    "class",
                                    0 === a ? this.b : this.e
                    ...
                    for (
                        ya("clearProps", {
                            ...
                            j =
                                "bezier,throwProps,physicsProps,physics2D".split(
                                    ","
                                ),
                            wa = j.length;
                        wa--;
            ...
            if (!e.TweenLite) {
                ...
                E(),
                    ...
                    (h.reverse = function (a, b) {
                        return (
                            null != a &&
                                this.seek(a || this.totalDuration(), b),
                    ...
                    (D._updateRoot = G.render =
                        function () {
                            ...
                            if (
                                ...
                                Y =
                                    i.frame +
                                    (parseInt(G.autoSleep, 10) || 120);
                                for (c in S) {
                                    for (
                                        b = S[c].tweens, a = b.length;
                                        --a > -1;
            ...
            proto: {
                ...
                _getOffset: function (n) {
                    ...
                    var s = {
                        width: i.width(),
                        height:
                            (w ? i.innerHeight() : i[0].offsetHeight) - a - r,
                    };
                    return (
                        W()
        ...
        function o(n) {
            e.requestAnimationFrame(function () {
                ...
                for (var e = 0, o = g.length; o > e; e++)
                    "scroll" !== n.type &&
                        (g[e].coverImage(), g[e].clipContainer()),
                        g[e].onScroll();
            });
        }
        Date.now ||
            ...
            f = (function () {
                function e(e, n) {
                    ...
                    if (
                        ...
                        (o = JSON.parse(
                            i.$item.getAttribute("data-jarallax") || "{}"
                        )),
                ...
                if (e.image.width && e.image.height) {
                    ...
                    c &&
                        ...
                        c
                            ...
                            : ((g = (n - u) / 2), (f = (o - d) / 2)),
                        r &&
                            e.options.enableTransform &&
                            e.parentWithTransform &&
                            (g -= i),
            ...
            for (a; i > a; a++)
                if (
                    ("object" == typeof n || "undefined" == typeof n
                        ...
                        : e[a].jarallax &&
                          (t = e[a].jarallax[n].apply(e[a].jarallax, o)),
                    "undefined" != typeof t)
                )
                    return t;
            return e;
        ...
        n(e, "DOMContentLoaded", function () {
            h(
                document.querySelectorAll(
                    "[data-jarallax], [data-jarallax-video]"
                )
            );
        });
    })(window);
        ...
        (function (a, b, c, d) {
            ...
            (e.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
                ...
                (e.prototype.thumbnail = function (b, c) {
                    ...
                    if (
                        (b.wrap(
                            '<div class="owl-video-wrapper"' + g + "></div>"
                        ),
                        this._core.settings.lazyLoad &&
                    ...
                    c(this, a),
                        ...
                        null != b.scrollContainer &&
                            (this.config.scrollContainer =
                                document.querySelector(b.scrollContainer)),
        ...
        !E(A, "undefined") && !E(A.call, "undefined")
            ...
            (s.smil = function () {
                return (
                    !!b.createElementNS &&
                    /SVGAnimate/.test(
                        m.call(b.createElementNS(r.svg, "animate"))
                    )
                );
            }),
            (s.svgclippaths = function () {
                return (
                    !!b.createElementNS &&
                    /SVGClipPath/.test(
                        m.call(b.createElementNS(r.svg, "clipPath"))
                    )
                );
            });
        for (var K in s)
