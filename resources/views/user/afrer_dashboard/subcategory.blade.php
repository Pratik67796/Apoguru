                ...
                <div class="course__item white-bg mb-30 fix">
                    <div class="course__thumb w-img p-relative fix">
                        <a href="{{ route('course-details',['slug' => $data2->slug,'uid'=>$data2->uid]) }}">
                            <img src="{{ asset('storage/course-images/'.$data2->image) }}" alt="">
                        </a>
                    ...
                    <div class="course__content">
                        ...
                        <h3 class="course__title">
                          <a href="{{ route('course-details',['slug' => $data2->slug,'uid'=>$data2->uid]) }}">
                            {{strip_tags($data2['title'])}}
                          </a>
                        </h3>
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="course__teacher d-flex align-items-center">
                                <div class="course__teacher-thumb mr-15">
                                    @if(isset($data2['User']['avatar']))
                                    <img src="{{ asset('storage/users/' . $data2['User']['avatar']) }}" alt="">
                                    @else
                                ...
                                <h6>
                                  <a href="{{ route('course-details',['slug' => $data2->slug,'uid'=>$data2->uid]) }}">
                                    {{ isset($data2['User']['name']) ? $data2['User']['name'] : 'Admin'}}
                                  </a>
                                </h6>
                            </div>
                            <div class="extra-buttons">
                                ...
                                <a href="javascript:void(0)" onClick="addToWishList({{ Auth::guard('user_new')->user()->id }},{{ $data2->id }})">
                                  <i class="far fa-heart wishlist-heart @if($data2->getWishList) fas @endif" id="fas-{{ $data2->id }}"></i>
                                </a>
                                @else
