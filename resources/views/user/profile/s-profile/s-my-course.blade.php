    ...
    <div class="section overflow-hidden position-relative" id="wrapper">
      ...
      <div class="page-content-wrapper py-0">
        ...
        <div class="nav flex-column admin-tab-menu in-pro-admin-tab-menu">
          ...
          <a href="s-my-course.html" class="active"><i class="icofont-computer"></i> My Courses</a>
                  ...
                  <div class="courses-wrapper">
                    <div class="row">
                      <div class="col-lg-6 col-md-12">
                        <div class="single-courses">
                          <div class="courses-images">
                            <a href="../buyed-course.html"><img src="{{ URL::asset('assets/images/courses/courses-01.jpg')}}" alt="Courses"></a>
                          </div>
                          <div class="courses-content">
                            ...
                            <h4 class="title"><a href="../buyed-course.html">Data Science and Machine Learning with Python - Hands On!</a></h4>
                      ...
                      <div class="col-lg-6 col-md-12">
                        <div class="single-courses">
                          <div class="courses-images">
                            <a href="../buyed-course.html"><img src="{{ URL::asset('assets/images/courses/courses-03.jpg')}}" alt="Courses"></a>
                          </div>
                          <div class="courses-content">
                            <div class="courses-author">
                              <div class="author">
                            ...
                            <h4 class="title"><a href="../buyed-course.html">Culture & Leadership: Strategies for a Successful Business</a></h4>
                            <div class="courses-meta">
                              <span> <i class="icofont-clock-time"></i> 08 hr 15 mins</span>
                              <span> <i class="icofont-read-book"></i> 29 Lectures </span>
                            </div>
                      ...
                      <div class="col-lg-6 col-md-12">
                        <div class="single-courses">
                          ...
                          <div class="courses-content">
                            ...
                            <h4 class="title"><a href="../buyed-course.html">Build Brand Into Marketing: Tackling the New Marketing Landscape</a></h4>
                            <div class="courses-meta">
                              <span> <i class="icofont-clock-time"></i> 08 hr 15 mins</span>
                              <span> <i class="icofont-read-book"></i> 29 Lectures </span>
                            </div>
                      ...
                      <div class="col-lg-6 col-md-12">
                        <div class="single-courses">
                          <div class="courses-images">
                            <a href="../buyed-course.html"><img src="{{ URL::asset('assets/images/courses/courses-06.jpg')}}" alt="Courses"></a>
                          </div>
                          <div class="courses-content">
                            <div class="courses-author">
                              <div class="author">
                            ...
                            <h4 class="title"><a href="../buyed-course.html">Graphic Design: Illustrating Badges and Icons with Geometric Shapes</a></h4>
                            <div class="courses-meta">
                              <span> <i class="icofont-clock-time"></i> 08 hr 15 mins</span>
                              <span> <i class="icofont-read-book"></i> 29 Lectures </span>
                            </div>
                  ...
                  <div class="courses-wrapper">
                    <div class="row">
                      <div class="col-lg-6 col-md-12">
                        <div class="single-courses">
                          <div class="courses-images">
                            <a href="../buyed-course.html"><img src="{{ URL::asset('assets/images/courses/courses-02.jpg')}}" alt="Courses"></a>
                          </div>
                          <div class="courses-content">
                            <div class="courses-author">
                              <div class="author">
                      ...
                      <div class="col-lg-6 col-md-12">
                        <div class="single-courses">
                          <div class="courses-images">
                            <a href="../buyed-course.html"><img src="{{ URL::asset('assets/images/courses/courses-05.jpg')}}" alt="Courses"></a>
                          </div>
                          <div class="courses-content">
                            <div class="courses-author">
                              <div class="author">
                            ...
                            <h4 class="title"><a href="../buyed-course.html">Create Amazing Color Schemes for Your UX Design Projects</a></h4>
                            <div class="courses-meta">
                              <span> <i class="icofont-clock-time"></i> 08 hr 15 mins</span>
                              <span> <i class="icofont-read-book"></i> 29 Lectures </span>
                            </div>
                      ...
                      <div class="col-lg-6 col-md-12">
                        <div class="single-courses">
                          <div class="courses-images">
                            <a href="../buyed-course.html"><img src="{{ URL::asset('assets/images/courses/courses-04.jpg')}}" alt="Courses"></a>
                          </div>
                          <div class="courses-content">
                            <div class="courses-author">
                              <div class="author">
                            ...
                            <h4 class="title"><a href="../buyed-course.html">Finance Series: Learn to Budget and Calculate your Net Worth.</a></h4>
                            <div class="courses-meta">
                              <span> <i class="icofont-clock-time"></i> 08 hr 15 mins</span>
                              <span> <i class="icofont-read-book"></i> 29 Lectures </span>
                            </div>
