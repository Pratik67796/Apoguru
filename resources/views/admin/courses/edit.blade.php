...
@section('styles')
    ...
    <link href="{{ URL::asset('admin_theme/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css') }}"
        rel="stylesheet">
@endsection
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-8">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select id="main_category" class="form-control show-tick"
                                                    name="main_category_id" required>
                                                    <option value="">--Select Main Category--</option>
                                                    @foreach ($main_categories as $category)
                                                        <option value="{{ $category->id }}"
                                                            @if ($course->main_category_id == $category->id) selected @endif>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-8">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select id="parent_sub_category" class="form-control show-tick"
                                                    name="parent_sub_category_id" required>
                                                    <option value="">--Select Parent Sub Category--</option>
                                                    <option value="{{ $course->parent_sub_category_id }}" selected>
                                                        {{ $course->parentSubCategory->name }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-8">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select id="child_sub_category" class="form-control show-tick"
                                                    name="child_sub_category_id" required>
                                                    <option value="">--Select Child Sub Category--</option>
                                                    <option value="{{ $course->child_sub_category_id }}" selected>
                                                        {{ $course->childSubCategory->name }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="actual_price" class="form-control"
                                                    value="{{ $course->actual_price }}" required>
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="sell_price" class="form-control"
                                                    value="{{ $course->sell_price }}" required>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-8">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select id="recommeded_course" class="form-control show-tick"
                                                    name="recommeded_course[]" multiple>
                                                    <option value="">--Select Recommeded Course--</option>
                                                    @foreach ($course->getRecommendedCourses as $recommendedCourse)
                                                        <option value="{{ $recommendedCourse->id }}" selected>
                                                            {{ $recommendedCourse->getCourse->title }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
...
@section('scripts')
    ...
    <script src="{{ URL::asset('admin_theme/plugins/jquery-datatable/skin/bootstrap/js/dataTables.bootstrap.js') }}">
    </script>
    <script src="{{ URL::asset('admin_theme/plugins/jquery-datatable/extensions/export/dataTables.buttons.min.js') }}">
    </script>
        ...
        $('#parent_sub_category').on('change', function(e) {
            ...
            $('#child_sub_category').on('change', function() {
                $.ajax({
                    ...
                    success(res) {
                        console.log(res);
                        $('#recommeded_course option:not(:first)').remove();
